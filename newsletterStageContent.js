...
const REWARD_TIERS = [
  ...
  },
  {
    ...
    perk: 'Test new features 2 weeks early',
    type: 'early_access',
  },
  {
    id: 'store_20',
  ...
  },
  {
    ...
    perk: 'Secret themes + premium prompts + custom title',
  ...
  },
  {
    ...
    perk: 'Badge + co-create + two 50% coupons',
    type: 'matriarch',
  },
];
...
function getNextTierProgress(points) {
  ...
  if (!next) {
    ...
    return {
      points: total,
      nextTier: null,
      nextTitle: 'All Crown Points tiers unlocked',
      nextPerk: last.perk,
      progress: 1,
      pointsToNext: 0,
